...
class TrainOptions:
    ...
    def __init__(self):
        ...
        train.add_argument('--model_name', type=str, default="cliff", help='', choices=['hmr', 'cliff', 'mutilROI', 'metaHMR'])
        ...
        train.add_argument('--test_epochs', type=int, default=10, help='Testing frequency during training')
        ...
        train.add_argument('--after_innerlr', type=float, default=1e-5, help='the inner lr')
        train.add_argument('--test_val_step', type=int, default=14, help='# of inner step')
